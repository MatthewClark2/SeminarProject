...
public interface Bindings {
     ...
     * @throws IllegalRebindingException if the identifier is already associated with immutable
     * data.
     */
     ...
     * @throws NoSuchBindingException if the given identifier has not been bound.
     */
